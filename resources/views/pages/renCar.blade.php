        ...
        <div class="container">
            ...
            <div class="col-lg-12 col-md-10 banner-right" style="padding-top: 50px">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                    <a class="nav-link active show" id="holiday-tab" data-toggle="tab" href="#holiday" role="tab" aria-controls="holiday" aria-selected="false"><i class="fa-solid fa-car"></i> Cho thuê xe</a>
                    </li>
                </ul>
